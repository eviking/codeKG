...
- `services/api/nl_query.py`
- `services/api/tests/test_llm_audit.py`
...
| `package_fqn` | `tools` |
| `prov_commit_sha` | `b3a69148932eca7b01b8354c11f4957c656d8426` |
| `prov_confidence` | `0.85` |
| `prov_freshness_ts` | `2026-06-08T19:07:30Z` |
...
| `key_dependencies` | `[]` |
| `language` | `python` |
| `last_commit` | `3198875f970b24c913a327f87fd4a79ae36e8db6` |
| `name` | `codeKG` |
...
| Property | Example value |
|---|---|
| `cypher_constraint` | `MATCH (c:Class {repo_id: $repo_id, kind: 'module'}) WHERE c.javadoc IS NULL RETU` |
| `natural_language` | `Every Python module file must have a module-level docstring. Module docstrings a` |
| `policy_id` | `policy-undoc-module` |
| `repo_id` | `codeKG` |
| `sample_violators` | `['services.console.agent_index.store', 'services.console.routes.tribal_knowledge` |
| `severity` | `warning` |
| `source` | `manual` |
| `status` | `active` |
...
| `severity` | `info` |
| `source` | `Python` |
| `top_packages` | `[{"package": "services.console.tests.test_console", "count": 12}, {"package": "s` |
