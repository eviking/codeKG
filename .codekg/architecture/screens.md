...
_29 page endpoint(s) detected._
...
**Linked from:** `/getstarted`

**Links to:** `/getstarted`, `/hygiene/{{ r.repo_id }}`, `/insights`, `/repos`, `/repos/{{ r.repo_id }}`
...
**Linked from:** `/agent-index/file/{file_key:path}`, `/getstarted`
...
**Linked from:** `/classes/summarise/{job_id}`, `/classes/{fqn:path}`, `/getstarted`, `/hygiene/{repo_id:path}`, `/hygiene/{repo_id}/refactor`, `/modules/{module_id:path}`, `/policies/{policy_id}`
...
**Linked from:** `/classes`, `/classes/summarise/{job_id}`, `/getstarted`, `/hygiene/{repo_id:path}`, `/hygiene/{repo_id}/refactor`, `/modules/{module_id:path}`, `/policies/{policy_id}`
...
#### `GET /getstarted`
**Template:** `getstarted.html`  **Route file:** `services/console/routes/getstarted.py`
...
**Links to:** `/`, `/agent-index`, `/classes`, `/config`, `/insights`, `/mcp-audit`, `/repos`, `/repos/{{ rid }}`
...
**Linked from:** `/`, `/getstarted`, `/modules/{module_id:path}`, `/repos/{repo_id:path}`
...
**Linked from:** `/`, `/getstarted`, `/modules/{module_id:path}`, `/repos`
...
_43 JSON/plain-text endpoint(s) — consumed by the console UI, MCP server, or CI._
...
| `POST` | `/getstarted/config` | `services/console/routes/getstarted.py` | — |
| `GET` | `/getstarted/ollama-status` | `services/console/routes/getstarted.py` | — |
| `POST` | `/getstarted/publish` | `services/console/routes/getstarted.py` | — |
| `POST` | `/getstarted/register` | `services/console/routes/getstarted.py` | — |
| `GET` | `/getstarted/status` | `services/console/routes/getstarted.py` | — |
